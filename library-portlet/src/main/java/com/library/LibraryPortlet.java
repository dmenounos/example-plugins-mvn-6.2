...
public class LibraryPortlet extends MVCPortlet {
	...
	public void render(RenderRequest request, RenderResponse response) 
		...
		String componentId = ParamUtil.getString(request, LibraryConstants.COMPONENT_ID_ATTR);

		if (StringUtils.isNotEmpty(componentId)) {
			request.setAttribute(LibraryConstants.COMPONENT_ID_ATTR, componentId);
		}
		...
		if (StringUtils.isEmpty(jspPage) || 
			...
			try {
				String searchTerm = ParamUtil.getString(request, LibraryConstants.SEARCH_TERM_ATTR);
				...
				String orderByCol  = ParamUtil.getString(request, LibraryConstants.ORDER_BY_COL_ATTR, "bookTitle");
				String orderByType = ParamUtil.getString(request, LibraryConstants.ORDER_BY_TYPE_ATTR, "asc");
				...
				request.setAttribute(LibraryConstants.SEARCH_TERM_ATTR, searchTerm);
				...
				request.setAttribute(LibraryConstants.ORDER_BY_COL_ATTR, orderByCol);
				request.setAttribute(LibraryConstants.ORDER_BY_TYPE_ATTR, orderByType);
			}
